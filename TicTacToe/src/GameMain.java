...
public class GameMain extends JPanel implements MouseListener{
	...
	public GameMain() {   
		...
		// DONE: Adds the mouse listener to the current class
		...
		// DONE: Create a new Board instance named board and call the method
		board = new Board();
	}
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				//DONE: Create new GameMain instance, add using the .add method of JFrame
				frame.add(new GameMain());
				
				
				//TODO: set the default close operation of the frame to exit_on_close
		        //DONE: When OS sends close command, exits code and frame to free memory and prevent app running in background
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				//DONE: Set statusBar variable text to x turn
				statusBar.setText("X's Turn");
				
			} else {    
				statusBar.setText("O's Turn");
				//TODO: use the status bar to display the message "O"'s Turn
				//DONE: Set statusBar variable text to o turn
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			// DONE: Nest an if-else-if to update currentState to current player once hasWon has been met.
			if(board.hasWon(thePlayer, row, col)) {
				...
				// DONE: Use assignment operator to change currentState if hasWon is false
