...
public class Board {
	...
	public Board() {
	 ...
	 //DONE: Initialise "cells" Cell array with variables from GameMain class, could use "3" but better to avoid magic numbers. 
	...
	public boolean isDraw() {
		...
		// DONE: For loop over rows and columns, if any cell has Empty enum state, isDraw returns false and game continues, otherwise isDraw returns true. 
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[playerRow][0].content == thePlayer && cells[playerRow][1].content == thePlayer && cells[playerRow][2].content == thePlayer )
		 ...
		 // DONE: Check if content of each row matches thats of the current player and returns hasWon to true.
